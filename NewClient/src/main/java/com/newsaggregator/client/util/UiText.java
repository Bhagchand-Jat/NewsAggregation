...
public final class UiText {
    ...
    public static final String CONFIGURE_NOTIFICATIONS = "Configure Notifications";
    public static final String DATE_RANGE_FORMAT = "Format should be dd-MM-yyyy:dd-MM-yyyy";
    public static final String INVALID_DATE_FORMAT = "Invalid dates – please follow dd-MM-yyyy pattern.";
    public static final String ADD_KEYWORDS_TO_CATEGORY = "Add keywords to category";

    // === Common ===
    public static final String CHOICE = "Enter your Choice: ";
    public static final String INVALID = "Invalid choice. Please try again.";
    public static final String PRESS_RETURN = "Press Enter to return...";
    public static final String INPUT_ERROR = "Input error: ";
    public static final String UNEXPECTED_ERROR = "Unexpected error: ";
    public static final String CHOOSE_OPTION_BELOW = "Please choose options below";
    ...
    // === Auth Labels ===
    public static final String WELCOME_HEADER = "Welcome to the News Aggregator";
    public static final String WELCOME_USER_HEADER = "Welcome to The New Aggregation System";
    public static final String LOGIN_OPTION = "Login";
    public static final String SIGNUP_OPTION = "Sign Up";
    ...
    // === Admin Headers ===
    public static final String SOURCES_HEADER = "External news servers:";
    public static final String SOURCE_DETAILS_HEADER = "External server details:";
    ...
    // === User Headers ===
    public static final String HEADLINES_HEADER = "H E A D L I N E S";
    public static final String SAVED_ARTICLES_HEADER = "S A V E D - A R T I C L E S";
    public static final String SEARCH_ARTICLES_HEADER = "S E A R C H - A R T I C L E S";
    public static final String NOTIFICATIONS_HEADER = "N O T I F I C A T I O N S";
    public static final String CONFIGURE_NOTIFICATIONS_HEADER = "C O N F I G U R E - N O T I F I C A T I O N S";
    // === User Prompts ===
    ...
    public static final String VIEW_CATEGORIES = "View Categories";
    public static final String ADD_CATEGORY = "Add Category";
    public static final String UPDATE_CATEGORY_STATUS = "Update Category Status";
    public static final String VIEW_ARTICLES = "View Articles";
    public static final String UPDATE_ARTICLE_STATUS = "Update Article Status";
    public static final String NOTIFICATIONS = "Notifications";
    public static final String REPORTED_ARTICLES = "View Reported Articles";
